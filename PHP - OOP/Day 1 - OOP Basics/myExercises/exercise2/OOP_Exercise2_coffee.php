...
/*
	...
	Create a class 'CoffeeCup' with these properties : DONE
		- quantity (cl)
		- brand (brand of coffee)
		- temperature

	All properties are private DONE

	Create all getters and setters for this class. DONE

	Use example :

	$myCoffee = new CoffeeCup();
	$myCoffee->setQuantity(30);
...
/*
	...
	Create these methods :
		...
		When calling this method, program will display 'Remain XX cl of coffee' DONE

		Example :
		$myCoffee->sip(3);

		- refill : no arguments and just fill to maximum
		When calling this method, program will display 'Mug full again'; DONE
		Example :
		$myCoffee->refill();
...
/* 
	...
	Display also a message, example : "You sip X cl, left Y cl of coffee" 
