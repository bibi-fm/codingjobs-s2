...
/*
    ...
    Create a Log class. DONE

    This class will be used to display a Log message like this one : '2021-04-26 14:00:03 - Accessing file'; DONE

    Create a static function in the class to match the instructions.
    Everytime this method is called, you will append the log in a file (dont override it).
