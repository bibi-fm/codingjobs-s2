...
Step 1 : DONE
    - Create an ArtistModel and add a method to insert an Artist DONE
    This method is taking four(4) arguments : name, gender, birth_year and bio. DONE

    - Method should return true or false. DONE

Step 2 : DONE
    - Create a view NewArtistView, that displays a form to insert a new Song. DONE


Step 3 : 
    - Create ArtistController and add a method to handle displaying the form
