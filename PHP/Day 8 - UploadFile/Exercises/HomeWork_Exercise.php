...
/*
    ...
    (a) Create an 'account.php' page
    (b) In this page, display all the informations about the user : username / email and picture
    (c) Create a 'Delete' button/link. When you click, it should :
        (c.1) Delete the user from the DB
        (c.2) Redirect to register page
